...
import cn.youth.datacollection.core.constant.KettleConfig;
import cn.youth.datacollection.core.dto.QuartzDTO;
import cn.youth.datacollection.core.enums.GlobalStatusEnum;
import cn.youth.datacollection.core.enums.RunStatusEnum;
import cn.youth.datacollection.core.enums.RunTypeEnum;
import cn.youth.datacollection.core.exceptions.MyMessageException;
import cn.youth.datacollection.core.execute.JobExecute;
import cn.youth.datacollection.core.execute.TransExecute;
import cn.youth.datacollection.core.quartz.QuartzManage;
import cn.youth.datacollection.core.quartz.ScriptQuartz;
                ...
                case REP:
                    if (script.getScriptType() == "0") {
                        ...
                        logText = TransExecute.run(RepositoryUtil.getAbstractRepository(script.getScriptRepositoryId())
                                , script.getScriptPath(), script.getScriptName()
                                , null, params
                                , LogLevel.getLogLevelForCode(script.getScriptLogLevel()), scriptId);
                    }
                    break;
                case FILE:
                    if (script.getScriptType() == "0") {
