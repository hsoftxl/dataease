 ...
 **/
@EnableConfigurationProperties(cn.youth.datacollection.core.pool.RepositoryPoolProperties.class)
@Configuration
public class RepositoryPoolAutoConfiguration {

    private final RepositoryPoolProperties poolProperties;

    private cn.youth.datacollection.core.pool.RepositoryObjectPool pool;
    ...
    @ConditionalOnClass({cn.youth.datacollection.core.pool.RepositoryObjectPool.class})
