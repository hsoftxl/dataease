...
import cn.youth.datacollection.core.repository.DataBaseRepository;
import cn.youth.datacollection.core.repository.FileRepository;
import cn.youth.datacollection.entity.KRepository;
import cn.youth.datacollection.service.KRepositoryService;
import cn.youth.datacollection.util.SpringContextUtil;
    ...
    public PooledObject<RepositoryObject> makeObject(String key) throws Exception {
        ...
        switch (repositoryDetail.getRepType()){
            case "dbRep":
                ...
                break;
            case "fileRep":
                repository = new FileRepository().buildRepository(repositoryDetail);
                break;
            default:
        }
        if (repository == null){
