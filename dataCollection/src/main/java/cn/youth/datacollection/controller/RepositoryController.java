...
import cn.youth.datacollection.entity.QueryHelper;
import cn.youth.datacollection.service.KRepositoryService;
...
public class RepositoryController {
    ...
    public Result<TreeDTO<String>> findJobRepTreeById(@RequestParam("id") String id, @RequestParam(value = "type", required = false) String type) throws Exception {
        TreeDTO<String> treeDTO = null;
        if ("0".equals(type)) {
            treeDTO = repositoryService.findRepTreeById(id, RepositoryObjectType.JOB);
        } else if ("1".equals(type)) {
            treeDTO = repositoryService.findRepTreeById(id, RepositoryObjectType.TRANSFORMATION);
        } else {
            treeDTO = repositoryService.findRepTreeById(id, null);
        }
